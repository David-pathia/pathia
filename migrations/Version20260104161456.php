 ...
 */
final class Version20260104161456 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE newsletter_source ADD CONSTRAINT FK_E5D0243A22DB1917 FOREIGN KEY (newsletter_id) REFERENCES newsletter (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    }
